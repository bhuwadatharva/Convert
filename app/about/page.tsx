...
export default function About() {
    return (
       ...
       <div className="flex items-center justify-center">
        ...
        <p className="ml-44 mt-10 text-xl">"Unlock the power of seamless document conversion with our PDF converter website. Say goodbye to file format headaches as you effortlessly convert PDFs into editable documents. Whether it's Word, Excel, or PowerPoint, our user-friendly platform ensures precision and efficiency. Experience the convenience of instant conversion without compromising on quality. Join thousands of satisfied users who trust us for their document transformation needs. Embrace simplicity and reliability with our PDF converter today!"</p>
        </div>
...
<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 py-3">
    ...
    <div className="p-5">
        ...
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 text-base text-center">"Image conversion refers to the process of transforming an image from one file format, resolution, or color space to another."</p>
    </div>
</div>
...
<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="p-5">
        ...
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 ml-7 text-base text-center">"Audio transformation involves altering or manipulating sound signals to achieve desired effects or enhancements."</p>
        </div>
</div>
...
<div className="max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    ...
    <div className="p-5">
        ...
        <p className="mb-3 font-normal text-gray-700 dark:text-gray-400 ml-7 text-base text-center">"Video metamorphosis seamlessly transforms visual narratives, bridging imagination and reality through the art of digital evolution."</p>
    </div>
</div>
