...
export default function PrivacyPolicy() {
  return (
    <div className="p-4">
      ...
      <h1 className="text-center lg:text-left font-bold text-3xl lg:text-5xl mt-8 lg:mt-20 lg:ml-[586px]">
        Privacy Policy
      </h1>
      <p className="mt-6 lg:mt-10 text-center lg:text-left lg:ml-44">
        At [Website Name], we are committed to protecting your privacy and
        ...
        provide when using our PDF converter website.
      </p>
      <div className="space-y-4 mt-8 max-w-2xl mx-auto lg:ml-44">
        ...
        <div className="space-y-2">
          ...
          <p>
            ...
            information confidential. We may also disclose your information when
            we believe it is necessary to comply with the law, enforce our site
